...
Η συγκεκριμένη εργασία, η τρίτη και τελευταία, κρίνεται ως η πιο εποικοδομητική και παραγωγική. Πολύ πιθανόν, αυτό να αποτελεί μια φυσική εξέλιξη, καθώς υπήρχε πλέον μεγαλύτερη εξοικείωση με την όλη διαδικασία.  
Το **McPAT** ήταν πολύ απλούστερο στην εγκατάσταση όσο και στην χρήση του σε σχέση με τον **gem5**. Βέβαια, οφείλουμε να ομολογήσουμε ότι είναι άλλη η δυναμική του κάθε εργαλείου και αυτός είναι και ο λόγος ύπαρξης διαφορετικών 
