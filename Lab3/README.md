...
o Xeon μπορεί να τρέξει την ίδια εφαρμογή 40 φορές γρηγορότερα απο τον Α9. 
εξηγείστε χρησιμοποιώντας το McPAT γιατί o Xeon δεν μπορεί να είναι πιο energy efficient από τον A9 παρά τη διαφορά στην απόδοση.
