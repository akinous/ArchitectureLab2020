...
>    >    >
>    >    > ii) [Γραφική αναπαράσταση αποτελεμάτων](#γραφική-αναπαράσταση-αποτελεμάτων)
>    >    >
>    >    > iii) [Σχολιασμός αποτελεσμάτων](#σχολιασμός-αποτελεσμάτων)
>    >
>    > 3) [...](#1.c)
>
> **_Βήμα 2<sup>ο</sup>_**
...
## Γραφική αναπαράσταση αποτελεμάτων  
<br>
<br>
