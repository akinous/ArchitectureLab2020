...
Συμβουλευόμενοι το αρχείο **stats.txt**, το ρολόι `system.clk_domain.clock` είναι ρυθμισμένο στο 1 GHz (1000) και είναι υπεύθυνο για τον χρονισμό του ρολογιού του συστήματος.
Από την άλλη, το ρολόι `system.cpu_clk_domain.clock` χρονίζει το ρολόι του επεξεργαστή (**_cpu_**), άρα και των caches που μελετάμε εδώ. Από προεπιλογή 
