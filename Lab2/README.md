...
Από την άλλη, το miss-rate της L1 Instruction Cache δεν επηρεάζει σημαντικά το συνολικό χρόνο εκτέλεσης των προγραμμάτων. Πλην, το πρόγραμμα Spechmmer παρουσιάζει μεγάλη διαφορά με τα miss-rate των άλλων προγραμμάτων στην L1 Instruction Cache.
...
| | bzip | mcf | hmmer | sjeng | libm |
| :---: | :---: | :---: | :---: | :---: | :---: |
| Execution Time (ms) | 160.3594 | 123.265 | -- | 705.640 | -- |
| CPI | 1.603595 | 1.251067 | -- | 7.056395 | -- | 
| L1 dCache MissRate (%) | 1.4123 | 0.2062 | -- | 12.1831 | -- |
| L1 iCache MissRate (%) | 0.0075 | 1.9046 | -- | 0.0020 | -- |
| L2 Cache MissRate  (%)| 29.5227 | 6.7668 | -- | 99.9978 | -- |
