...
Kρατήσαμε ολες τις **default** παραμέτρους ίδιες εκτός απο τον τύπο του cpu που από **AtomicSimpleCpu** τον αλλάξαμε σε **MinorCpu** , χρησιμοποιώντας το flag: **--cpu-type="minor"**.
