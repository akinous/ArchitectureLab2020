...
Όπως είδαμε πολλάκις παραπάνω το **MinorCPU** λειτουργεί με το γνωστό ***pipeline*** `Fetch1-Fetch2-Decode-Execute` το οποίο επιτρέπει στον επεξεργαστκή να εκτελεί παράλληλα διεργασίες. Πέραν τούτου η απλοικότητα του προγράμματος που εκτελέστηκε βοήθησε τον MinorCPU να είναι έξτρα αποδοτικός.
